...
urlpatterns = [
    ...
    path('login/', user_views.CustomLoginView.as_view(), name='login'),  # Updated this line
    ...
    path('profile/edit/', user_views.UserProfileUpdateView.as_view(), name='profile_edit'),
